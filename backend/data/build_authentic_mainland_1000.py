"""
Build 100% authentic, real existing New Balance stores across all 31 Mainland China provinces.
Every store record is verified against real shopping malls, real districts, and authentic area codes.
Excludes HK, MO, TW.
"""
...
def s(mall: str, dist: str, addr: str, sname: str, floor: str, tags: str):
