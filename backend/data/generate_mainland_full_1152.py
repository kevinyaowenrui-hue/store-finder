"""
Full 31-Province Mainland China (1,152 stores) New Balance Store Dataset Generator.
...
# Province definitions with city structures
ALL_MAINLAND_PROVINCES = [
    ...
    # 3. 天津市 (13)
    {
        "province": "天津市", "city": "天津市", "prefix": "022", "lat": 39.0842, "lng": 117.2009,
        "stores": [
    ...
    # 4. 重庆市 (16)
    {
        "province": "重庆市", "city": "重庆市", "prefix": "023", "lat": 29.5630, "lng": 106.5516,
        "stores": [
