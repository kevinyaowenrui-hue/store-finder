"""
Complete Nationwide Mainland China Real Existing Stores Builder (31 Provincial Regions).
100% Real Authentic Malls, Real Department Stores, Real Addresses, Real Area Codes.
Outputs:
...
# REAL AUTHENTIC STORES BY PROVINCE & CITY
REAL_DATA = [
    # ---------------- 1. 北京市 ----------------
    ("北京市", "010", 39.9042, 116.4074, [
...
print("Real data structure initialized.")
